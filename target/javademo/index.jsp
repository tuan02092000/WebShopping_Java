...
<c:if test="${sessionScope.user == null}">
	<c:redirect url="http://localhost:8080/WebShopping_war/login"></c:redirect>
</c:if>
								...
								<c:forEach items="${listCategory}" var="listCate">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordian" href="#${listCate.name}">
												<span class="badge pull-right"><i class="fa fa-plus"></i></span>
												${listCate.name}
											</a>
										</h4>
									</div>
									<div id="${listCate.name}" class="panel-collapse collapse">
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<c:forEach items="${listBrand}" var="listBrand">
										<li><a href="http://localhost:8080/WebShopping_war/product?brandId=${listBrand.id}"> <span class="pull-right">(${listBrand.count})</span>${listBrand.name}</a></li>
									</c:forEach>
								</ul>
							</div>
						</div><!--/brands_products-->
						...
						<div class="paging">
							<ul class="pagination">
								<c:forEach begin="1" end="${totalPage}" var="index">
									<li><a href="home?index=${index}">${index}</a></li>
								</c:forEach>
							</ul>
						</div>
					</div><!--features_items-->
